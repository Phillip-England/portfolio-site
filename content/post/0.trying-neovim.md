# [trying neovim]
<p>where are the casual vim users?<the-blinker rate='1000'>_</the-blinker></p>

<div class="relative rounded border-gray-300 w-[150px]">
    <img src="/static/img/post/0.webp" class="w-[150px] rounded" />
</div>
...
NOTE TO SELF: did you find a command line utility?
